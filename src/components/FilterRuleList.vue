...
<template>
  <div class="filter-rules">
    ...
    <div class="add-form">
      ...
      <button class="btn-primary" :disabled="!newValue.trim()" @click="addRule">Add</button>
    </div>

    <!-- Rules list -->
    <div class="list">
      <div v-if="store.filterRules.length === 0" class="empty">
        No ignore rules. All activity is shown.
      </div>
